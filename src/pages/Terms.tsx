...
const Terms = () => {
  return (
    ...
    >
      <h1 className="text-h1 font-bold text-vf-blue text-center mb-10">Conditions d'utilisation</h1>
      <div className="bg-vf-dark/60 backdrop-blur-md p-6 sm:p-8 rounded-xl shadow-2xl border border-vf-gray text-white space-y-6">
        ...
        <h2 className="text-h2 font-bold text-vf-purple mt-8 mb-4">1. Acceptation des Conditions</h2>
        <p className="text-p">
        ...
        <h2 className="text-h2 font-bold text-vf-purple mt-8 mb-4">2. Utilisation du Service</h2>
        <p className="text-p">
        ...
        <h2 className="text-h2 font-bold text-vf-purple mt-8 mb-4">3. Contenu Généré par l'Utilisateur</h2>
        <p className="text-p">
        ...
        <h2 className="text-h2 font-bold text-vf-purple mt-8 mb-4">4. Modifications des Conditions</h2>
        <p className="text-p">
