...
const Terms = () => {
  return (
    ...
    >
      <h1 className="text-4xl sm:text-5xl font-bold text-vf-blue text-center mb-10">Conditions d'utilisation</h1>
      <div className="bg-vf-dark/60 backdrop-blur-md p-8 rounded-xl shadow-2xl border border-vf-gray text-white space-y-6">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-vf-purple mt-8 mb-4">1. Acceptation des Conditions</h2>
        <p className="text-base sm:text-lg">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-vf-purple mt-8 mb-4">2. Utilisation du Service</h2>
        <p className="text-base sm:text-lg">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-vf-purple mt-8 mb-4">3. Contenu Généré par l'Utilisateur</h2>
        <p className="text-base sm:text-lg">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-vf-purple mt-8 mb-4">4. Modifications des Conditions</h2>
        <p className="text-base sm:text-lg">
